...
//┬ фюяюыэхэшх ъ ¤Єшь Єшярь т C++ ьюцэю ёючфртрЄ№ фшэрьшўхёъшх юс·хъЄ√.╧ЁюфюыцшЄхы№эюёЄ№ шї цшчэш эх чртшёшЄ юЄ Єюую, уфх юэш ёючфрэ√.
//─шэрьшўхёъшх юс·хъЄ√ ёє∙хёЄтє■Є, яюър эх сєфєЄ єфрыхэ√  тэ√ь юсЁрчюь.─шэрьшўхёъшх юс·хъЄ√ Ёрчьх∙р■Єё  т фшэрьшўхёъющ ярь Єш(free store).
//▌Єю юсырёЄ№ ярь Єш, эх чрэ Єр  юяхЁрЎшюээющ ёшёЄхьющ шыш фЁєушьш чруЁєцхээ√ьш т фрээ√щ ьюьхэЄ яЁюуЁрььрьш.
...
//	int* ptr{ new int{5} };
//	cout << *ptr << endl; //5
//	delete  ptr; //юётюсюцфрхь ярь Є№, т√фхыхээє■ фы  фшэрьшўхёъюую юс·хъЄр
//}
...
//	cout << *obj << endl; //10
//	delete obj; //юётюсюцфрхь ярь Є№, т√фхыхээє■ фы  фшэрьшўхёъюую юс·хъЄр
//}
//
//int main()
//{
...
//int main()
//{
//	unsigned n{ 5 };   // ЁрчьхЁ ьрёёштр
//	auto pnumbers{ std::make_unique<int[]>(n) };    // ьрёёшт шч n ¤ыхьхэЄют
//
//	// шчьхэшь ш т√тхфхь тёх ¤ыхьхэЄ√ эр ъюэёюы№
