...
//ЋЇ б­лҐ Ё ЎҐ§®Ї б­лҐ ЇаҐ®Ўа §®ў ­Ёп
...
//	bool res1{ !a }; //0
//	bool res2{ !res1 }; //1
//	//&& (Є®­ко­ЄжЁп, «®ЈЁзҐбЄ®Ґ г¬­®¦Ґ­ЁҐ)
//	bool res3{ a && b }; // 0
//	bool res4{ a && true }; //1
//	//|| (¤Ё§ко­ЄжЁп, «®ЈЁзҐбЄ®Ґ б«®¦Ґ­ЁҐ)
//	bool res5{ a || b }; //1
//	bool res6{ b || false }; //0
//	//^ ( XOR Ё«Ё eXclusive OR)
//	bool res7{ a ^ b }; //1
//	bool res8{ a ^ true }; //0	
//	bool res9{ b ^ false }; //0
//}
...
//int main()
//{
//	// ЎҐбЄ®­Ґз­л© жЁЄ« for - гб«®ўЁҐ § ўҐаиҐ­Ёп ®вбгвбвўгҐв
//	for (;;)
//	{
//
//	}
//	// ЎҐбЄ®­Ґз­л© жЁЄ« while - гб«®ўЁҐ ўбҐЈ¤  а ў­® true
//	while (true)
//	{
//
//	}
//	// ЎҐбЄ®­Ґз­л© жЁЄ« do-while - гб«®ўЁҐ ўбҐЈ¤  а ў­® true
//	do
//	{
//
//	} while (true);
...
//	int forth = numbers[4]; // !ЋиЁЎЄ  - ў ¬ ббЁўҐ в®«мЄ® 4 н«Ґ¬Ґ­в 
//	numbers[1] = 25; // numbers[1] = 23;    // ®иЁЎЄ  - §­ зҐ­Ёп н«Ґ¬Ґ­в®ў ¬ ббЁў  Ё§¬Ґ­Ёвм ­Ґ«м§п
//}
...
//	int* pa{ &a };
//	//*pa = 20;
//	std::cout << "address of pointer=" << &pa << std::endl;        //  ¤аҐб гЄ § вҐ«п
//	std::cout << "address stored in pointer=" << pa << std::endl;  //  ¤аҐб, Є®в®ал© еа ­Ёвбп ў гЄ § вҐ«Ґ -  ¤аҐб ЇҐаҐ¬Ґ­­®© a         
//	std::cout << "value on pointer=" << *pa << std::endl;          // §­ зҐ­ЁҐ Ї®  ¤аҐбг ў гЄ § вҐ«Ґ - §­ зҐ­ЁҐ ЇҐаҐ¬Ґ­­®© a
//}
...
//{
//	char c{ 'N' };
//	char* pc{ &c };            // гЄ § вҐ«м ­  бЁ¬ў®«
//	int* pd{ (int*)pc };      // гЄ § вҐ«м ­  int
//	void* pv{ (void*)pc };     // гЄ § вҐ«м ­  void
...
//	*pa = 20; // !ЋиЁЎЄ  - ­Ґ«м§п Ё§¬Ґ­Ёвм §­ зҐ­ЁҐ Ї®  ¤аҐбг, ­  Є®в®ал© гЄ §лў Ґв Є®­бв ­в­л© гЄ § вҐ«м
//	cout << "address = = " << pa << "\t value = " << *pa << endl;
//}
...
//	const int* pa{ &a };
//	const int b{ 46 };
//	pa = &b; // ¬®¦­® Ё§¬Ґ­Ёвм  ¤аҐб, ­  Є®в®ал© гЄ §лў Ґв Є®­бв ­в­л© гЄ § вҐ«м
//	cout << "address = " << pa << "\t value = " << *pa << endl;
...
//
//	int b{ 45 };
////	pa = &b; // !ЋиЁЎЄ  - ­Ґ«м§п Ё§¬Ґ­Ёвм  ¤аҐб, ­  Є®в®ал© гЄ §лў Ґв Є®­бв ­в­л© гЄ § вҐ«м
//}
...
//	//*pa = 22; // !ЋиЁЎЄ  - ­Ґ«м§п Ё§¬Ґ­Ёвм §­ зҐ­ЁҐ Ї®  ¤аҐбг, ­  Є®в®ал© гЄ §лў Ґв Є®­бв ­в­л© гЄ § вҐ«м
//	int b{ 45 };
//	//pa = b; // !ЋиЁЎЄ  - ­Ґ«м§п Ё§¬Ґ­Ёвм  ¤аҐб, ­  Є®в®ал© гЄ §лў Ґв Є®­бв ­в­л© гЄ § вҐ«м
//}
...
//	}
//
//	//nums++; // !ЋиЁЎЄ  - ­Ґ«м§п Ё§¬Ґ­Ёвм  ¤аҐб ¬ ббЁў 	
//	int b{ 8 };
//	//nums = &b; // !ЋиЁЎЄ  - ­Ґ«м§п Ё§¬Ґ­Ёвм  ¤аҐб ¬ ббЁў 
//}
...
//	char* phello{ hello };
//	cout << *phello << endl;
//	cout << (void*)phello << endl; //ўлў®¤Ёв  ¤аҐбб
//}
...
//void print()
//{
//	int n{ 5 };  // «®Є «м­ п ЇҐаҐ¬Ґ­­ п, Є®в®а п бгйҐбвўгҐв в®«мЄ® ў дг­ЄжЁЁ print
//	std::cout << "n=" << n << std::endl;
//	//в Є б¤Ґ« вм ­Ґ«м§п, в Є Є Є m ®ЇаҐ¤Ґ«Ґ­  ў дг­ЄжЁЁ main
//	// std::cout << "m=" << m << std::endl;
//}
//int main()
//{
//	int m{ 2 };  // «®Є «м­ п ЇҐаҐ¬Ґ­­ п, Є®в®а п бгйҐбвўгҐв в®«мЄ® ў дг­ЄжЁЁ main 
//	std::cout << "m=" << m << std::endl;
//	//в Є б¤Ґ« вм ­Ґ«м§п, в Є Є Є n ®ЇаҐ¤Ґ«Ґ­  ў дг­ЄжЁЁ print
//	// std::cout << "n=" << n << std::endl;
//}
...
//int main()
//{
//	int n1{ 2 };  // ®Ў« бвм ўЁ¤Ё¬®бвЁ - ўбп дг­ЄжЁп main 
//
//	{
//		int n2{ 5 };     // ®Ў« бвм ўЁ¤Ё¬®бвЁ - Ў«®Є Є®¤ 
//		std::cout << "n2=" << n2 << std::endl;
//		n1++;   // ЇҐаҐ¬Ґ­­ п n1 ¤®бвгЇ­ , в.Є. ®ЇаҐ¤Ґ«Ґ­  ў® ў­Ґи­Ґ¬ Є®­вҐЄбвҐ - дг­ЄжЁЁ
//	}   // Є®­Ґж Ў«®Є  дг­ЄжЁЁ - Є®­Ґж ўаҐ¬Ґ­Ё ¦Ё§­Ё ЇҐаҐ¬Ґ­­®© n2
//
//	// в Є ­Ґ«м§п - ЇҐаҐ¬Ґ­­ п n2 Ё§ Ў«®Є  дг­ЄжЁЁ г¦Ґ ­Ґ бгйҐбвўгҐв
//	// std::cout << "n2=" << n2 << std::endl;
//	// ЇҐаҐ¬Ґ­­ п n1 ¤®бвгЇ­  ¤® Є®­ж  дг­ЄжЁЁ
//	std::cout << "n1=" << n1 << std::endl;
//}   // Є®­Ґж Ў«®Є  дг­ЄжЁЁ - Є®­Ґж ўаҐ¬Ґ­Ё ¦Ё§­Ё ЇҐаҐ¬Ґ­­®© n1
...
//{
//	int n{ 10 };
//	cout << "n = " << ::n << endl;  //®Ўа йҐ­Ёп Ё¬Ґ­­® Є Ј«®Ў «м­®© ЇҐаҐ¬Ґ­­®©
//
//	{
//		int n{ 20 };
//		cout << "n = " << ::n << endl; //®Ўа йҐ­Ёп Ё¬Ґ­­® Є Ј«®Ў «м­®© ЇҐаҐ¬Ґ­­®©
...
//	//tom.name = "Tomas"; // нельзя обращятся
//	//tom.age = 22; //нельзя обращятся
