...
//int main()
//{
//	// ¡¥áª®­¥ç­ë© æ¨ª« for - ãá«®¢¨¥ § ¢¥àè¥­¨ï ®âáãâáâ¢ã¥â
//	for (;;)
//	{
//
//	}
//	// ¡¥áª®­¥ç­ë© æ¨ª« while - ãá«®¢¨¥ ¢á¥£¤  à ¢­® true
//	while (true)
//	{
//
//	}
//	// ¡¥áª®­¥ç­ë© æ¨ª« do-while - ãá«®¢¨¥ ¢á¥£¤  à ¢­® true
//	do
//	{
//
//	} while (true);
...
//	int forth = numbers[4]; // !è¨¡ª  - ¢ ¬ áá¨¢¥ â®«ìª® 4 í«¥¬¥­â 
//	numbers[1] = 25; // numbers[1] = 23;    // ®è¨¡ª  - §­ ç¥­¨ï í«¥¬¥­â®¢ ¬ áá¨¢  ¨§¬¥­¨âì ­¥«ì§ï
//}
...
//	int* pa{ &a };
//	//*pa = 20;
//	std::cout << "address of pointer=" << &pa << std::endl;        //  ¤à¥á ãª § â¥«ï
//	std::cout << "address stored in pointer=" << pa << std::endl;  //  ¤à¥á, ª®â®àë© åà ­¨âáï ¢ ãª § â¥«¥ -  ¤à¥á ¯¥à¥¬¥­­®© a         
//	std::cout << "value on pointer=" << *pa << std::endl;          // §­ ç¥­¨¥ ¯®  ¤à¥áã ¢ ãª § â¥«¥ - §­ ç¥­¨¥ ¯¥à¥¬¥­­®© a
//}
...
//	char c{ 'N' };
//	char* pc{ &c };            // ãª § â¥«ì ­  á¨¬¢®«
//	int* pd{ (int*)pc };      // ãª § â¥«ì ­  int
//	void* pv{ (void*)pc };     // ãª § â¥«ì ­  void
...
//	*pa = 20; // !è¨¡ª  - ­¥«ì§ï ¨§¬¥­¨âì §­ ç¥­¨¥ ¯®  ¤à¥áã, ­  ª®â®àë© ãª §ë¢ ¥â ª®­áâ ­â­ë© ãª § â¥«ì
//	cout << "address = = " << pa << "\t value = " << *pa << endl;
//}
...
//	const int* pa{ &a };
//	const int b{ 46 };
//	pa = &b; // ¬®¦­® ¨§¬¥­¨âì  ¤à¥á, ­  ª®â®àë© ãª §ë¢ ¥â ª®­áâ ­â­ë© ãª § â¥«ì
//	cout << "address = " << pa << "\t value = " << *pa << endl;
...
//
//	int b{ 45 };
////	pa = &b; // !è¨¡ª  - ­¥«ì§ï ¨§¬¥­¨âì  ¤à¥á, ­  ª®â®àë© ãª §ë¢ ¥â ª®­áâ ­â­ë© ãª § â¥«ì
//}
...
//	//*pa = 22; // !è¨¡ª  - ­¥«ì§ï ¨§¬¥­¨âì §­ ç¥­¨¥ ¯®  ¤à¥áã, ­  ª®â®àë© ãª §ë¢ ¥â ª®­áâ ­â­ë© ãª § â¥«ì
//	int b{ 45 };
//	//pa = b; // !è¨¡ª  - ­¥«ì§ï ¨§¬¥­¨âì  ¤à¥á, ­  ª®â®àë© ãª §ë¢ ¥â ª®­áâ ­â­ë© ãª § â¥«ì
//}
...
//	}
//
//	//nums++; // !è¨¡ª  - ­¥«ì§ï ¨§¬¥­¨âì  ¤à¥á ¬ áá¨¢ 	
//	int b{ 8 };
//	//nums = &b; // !è¨¡ª  - ­¥«ì§ï ¨§¬¥­¨âì  ¤à¥á ¬ áá¨¢ 
//}
...
//	char* phello{ hello };
//	cout << *phello << endl;
//	cout << (void*)phello << endl; //¢ë¢®¤¨â  ¤à¥áá
//}
...
//void print()
//{
//	int n{ 5 };  // «®ª «ì­ ï ¯¥à¥¬¥­­ ï, ª®â®à ï áãé¥áâ¢ã¥â â®«ìª® ¢ äã­ªæ¨¨ print
//	std::cout << "n=" << n << std::endl;
//	//â ª á¤¥« âì ­¥«ì§ï, â ª ª ª m ®¯à¥¤¥«¥­  ¢ äã­ªæ¨¨ main
//	// std::cout << "m=" << m << std::endl;
//}
//int main()
//{
//	int m{ 2 };  // «®ª «ì­ ï ¯¥à¥¬¥­­ ï, ª®â®à ï áãé¥áâ¢ã¥â â®«ìª® ¢ äã­ªæ¨¨ main 
//	std::cout << "m=" << m << std::endl;
//	//â ª á¤¥« âì ­¥«ì§ï, â ª ª ª n ®¯à¥¤¥«¥­  ¢ äã­ªæ¨¨ print
//	// std::cout << "n=" << n << std::endl;
//}
...
//int main()
//{
//	int n1{ 2 };  // ®¡« áâì ¢¨¤¨¬®áâ¨ - ¢áï äã­ªæ¨ï main 
//
//	{
//		int n2{ 5 };     // ®¡« áâì ¢¨¤¨¬®áâ¨ - ¡«®ª ª®¤ 
//		std::cout << "n2=" << n2 << std::endl;
//		n1++;   // ¯¥à¥¬¥­­ ï n1 ¤®áâã¯­ , â.ª. ®¯à¥¤¥«¥­  ¢® ¢­¥è­¥¬ ª®­â¥ªáâ¥ - äã­ªæ¨¨
//	}   // ª®­¥æ ¡«®ª  äã­ªæ¨¨ - ª®­¥æ ¢à¥¬¥­¨ ¦¨§­¨ ¯¥à¥¬¥­­®© n2
//
//	// â ª ­¥«ì§ï - ¯¥à¥¬¥­­ ï n2 ¨§ ¡«®ª  äã­ªæ¨¨ ã¦¥ ­¥ áãé¥áâ¢ã¥â
//	// std::cout << "n2=" << n2 << std::endl;
//	// ¯¥à¥¬¥­­ ï n1 ¤®áâã¯­  ¤® ª®­æ  äã­ªæ¨¨
//	std::cout << "n1=" << n1 << std::endl;
//}   // ª®­¥æ ¡«®ª  äã­ªæ¨¨ - ª®­¥æ ¢à¥¬¥­¨ ¦¨§­¨ ¯¥à¥¬¥­­®© n1
...
//	printVal(value);
//	//printRef(value); //ïğîãğàììà íå ñêîìïèëèğóåòñÿ, òàê êàê printRef îæèäàåò ññûëêó íà int, à ìû ïåğåäàåì double
//}
//
//void printVal(int n)
//{
...
//{
//	//n = n * n //òàêîé êîä íå ñêîìïèëèğóåòñÿ, òàê êàê n îáúÿâëåíà êàê êîíñòàíòíàÿ ïåğåìåííàÿ, è åå çíà÷åíèå íåëüçÿ èçìåíèòü
...
//void square(const int& n)
//{
//	//n = n * n; //òàêîé êîä íå ñêîìïèëèğóåòñÿ, òàê êàê n îáúÿâëåíà êàê êîíñòàíòíàÿ ññûëêà, è åå çíà÷åíèå íåëüçÿ èçìåíèòü
...
//{
//	//(*x)++; //òàêîé êîä íå ñêîìïèëèğóåòñÿ, òàê êàê x - óêàçàòåëü íà êîíñòàíòíûé int, è ìû íå ìîæåì èçìåíèòü çíà÷åíèå, íà êîòîğîå îí óêàçûâàåò
//	//cout << "Value: " << *x << endl;
//	int z{ 2 };
//	//x = &z;
//	cout << z << std::endl;   // 2
...
//void print(int arr[])
//{
//	//int size = sizeof(arr) / sizeof(arr[0]); //òàêîé êîä íå áóäåò ğàáîòàòü, òàê êàê arr - ıòî óêàçàòåëü íà int, à íå ìàññèâ, è sizeof(arr) âåğíåò ğàçìåğ óêàçàòåëÿ, à íå ğàçìåğ ìàññèâà);
//	//cout << size << endl;
//
//	//for (int n : arr) 
//	//{
...
//	print(numbers, n);
//	twice(numbers, n); //óâåëè÷èâàåì ìàññèâ â 2 ğàçà
//	print(numbers, n);
//}
//
...
//Â äîïîëíåíèå ê ıòèì òèïàì â C++ ìîæíî ñîçäàâàòü äèíàìè÷åñêèå îáúåêòû.Ïğîäîëæèòåëüíîñòü èõ æèçíè íå çàâèñèò îò òîãî, ãäå îíè ñîçäàíû.
//Äèíàìè÷åñêèå îáúåêòû ñóùåñòâóşò, ïîêà íå áóäóò óäàëåíû ÿâíûì îáğàçîì.Äèíàìè÷åñêèå îáúåêòû ğàçìåùàşòñÿ â äèíàìè÷åñêîé ïàìÿòè(free store).
//İòî îáëàñòü ïàìÿòè, íå çàíÿòàÿ îïåğàöèîííîé ñèñòåìîé èëè äğóãèìè çàãğóæåííûìè â äàííûé ìîìåíò ïğîãğàììàìè.
...
//	int* ptr{ new int{5} };
//	cout << *ptr << endl; //5
//	delete  ptr; //îñâîáîæäàåì ïàìÿòü, âûäåëåííóş äëÿ äèíàìè÷åñêîãî îáúåêòà
//}
...
//	cout << *obj << endl; //10
//	delete obj; //îñâîáîæäàåì ïàìÿòü, âûäåëåííóş äëÿ äèíàìè÷åñêîãî îáúåêòà
//}
//
//int main()
//{
...
//int main()
//{
//	unsigned n{ 5 };   // ğàçìåğ ìàññèâà
//	auto pnumbers{ std::make_unique<int[]>(n) };    // ìàññèâ èç n ıëåìåíòîâ
//
//	// èçìåíèì è âûâåäåì âñå ıëåìåíòû íà êîíñîëü
...
//int main()
//{
//	Person tom("Tom", 52); // âûçûâàåì êîíñòğóêòîğ Person(std::string p_name, unsigned p_age)
//	tom.print();
//	Person ben("Ben"); // âûçûâàåì êîíñòğóêòîğ Person(std::string p_name)
//	ben.print();
//	Person sam;
//	sam.print(); // âûçûâàåì êîíñòğóêòîğ Person()
//}
...
//{
//	Person tom{ "Tom", 38 };
//	// ïîëÿ name, age è ôóíêöèÿ print îáùåäîñòóïíûå
//	//tom.name = "Tomas"; // íåëüçÿ îáğàùÿòñÿ
//	//tom.age = 22; //íåëüçÿ îáğàùÿòñÿ
...
//{
//	Person tom{ "Tom", 38 };
//	Person tomas{ tom };    // ñîçäàåì îáúåêò tomas íà îñíîâå îáúåêòà tom
...
//{
//	Person tom{ "Tom", 38 };
//	Person tomas{ tom };    // êîíñòğóêòîğ êîïèğîâàíèÿ îòñóòñòâóåò
//	tomas.print();    // íå ñğàáîòàåò
//}
...
//	// ìû ìîæåì ïîëó÷èòü äàííûå êîíñòàíòû
//	std::cout << "Name: " << tom.name << "\tAge: " << tom.age << std::endl;
//	// íî èçìåíèòü èõ íåëüçÿ
//	// tom.name = "Tom";    // ! Îøèáêà
//	// tom.age = 38;        // ! Îøèáêà
//}
...
//	string name;
//	unsigned age;
//	static inline unsigned count{}; // ñòàòè÷åñêîå ïîëå - ñ÷åò÷èê îáúåêòîâ Person
//};
//
//int main()
//{
...
//		Person bob{ "Bob" };
//	
//	}// îáúåêòû Tom è Bob óíè÷òîæàşòñÿ
//
//	Person tom{ "Tom" };
//}// îáúåêò Sam óíè÷òîæàåòñÿ
